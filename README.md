...
Supports dynamic rendering, MSAA, graphics + compute pipelines, GPU CPU synchronization and dynamic memory barrier injections, ordered rendering to minimize frequency of descriptor set bindings, pipeline changes at runtime, CMake build systems, and more.
...
### Instructions
1. Download the Vulkan SDK at https://vulkan.lunarg.com/sdk/home (doesn't need add-ons when installing), and install at C:/VulkanSDK/1.4.350.0/Lib/vulkan-1.lib (better locating of the sdk path comming...)
2. Clone this repo
3. Open the root of the cloned repo in an IDE to compile Cmake
4. Build the project from the root CMakeLists.txt
5. Run
